    ...
    <div className="flex min-h-screen items-center justify-center p-6 bg-[#FFF5F5]">
      ...
      >
        ...
        <div className="relative z-10 mb-8">
          ...
          <p className="mt-2 text-sm text-zinc-500 font-medium">Access your Susu wallet securely.</p>
        </div>
        ...
        <div className="relative z-10 grid gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full rounded-2xl border px-4 py-3 outline-none focus:ring-2 transition-all bg-zinc-50 focus:bg-white ${fieldErrors.identifier ? "border-red-300 focus:border-red-500 focus:ring-red-500/20" : "border-zinc-200 focus:border-[#A8D5BA] focus:ring-[#A8D5BA]/20"}`}
            />
          </div>
          <div>
            ...
            <input
              ...
              className={`w-full rounded-2xl border px-4 py-3 outline-none focus:ring-2 transition-all text-xl tracking-widest font-semibold bg-zinc-50 focus:bg-white ${fieldErrors.pin ? "border-red-300 focus:border-red-500 focus:ring-red-500/20" : "border-zinc-200 focus:border-[#A8D5BA] focus:ring-[#A8D5BA]/20"}`}
            />
          </div>
        </div>
